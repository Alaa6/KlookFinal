...
export class EuropeTrainService {
  ...
  getAllTrips ():Observable <IEuropeTrains[]> 
  {
     return this.fs.collection <IEuropeTrains>('train-sights').valueChanges();
  ...
  getReviews():Observable <ITrainReview []>
  {
    return this.fs.collection <ITrainReview>('train-reviews').valueChanges();
  }
